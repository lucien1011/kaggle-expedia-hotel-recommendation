preprocess_conf = dict(
    ...
    click_rate_dir='storage/output/211223_book+click+rate+var_by+category/',
    book_rate_dir='storage/output/211223_book+click+rate+var_by+category/',
    click_var_dir='storage/output/211223_book+click+rate+var_by+category/',
    book_var_dir='storage/output/211223_book+click+rate+var_by+category/',
