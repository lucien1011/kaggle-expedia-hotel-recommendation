...
io_config = dict(
    ...
    output_dir='storage/output/211221_book_click_rate_by+category/',
)
...
def book_rate_by_group(train,match_cols=["srch_destination_id"]):
    ...
    return book_rate_map,click_rate_map
...
def run():
    ...
    for feature in features:
        book_rate,click_rate = book_rate_by_group(df,match_cols=[feature])
